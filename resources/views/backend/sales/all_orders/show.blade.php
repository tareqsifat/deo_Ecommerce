    ...
    <div class="card-body">
        <div class="row gutters-5">
            ...
            @endif
             ...
             <div class="col-md-3 ml-auto">
                <label for=update_payment_status"">{{translate('Creating Discount')}}</label>
            ...
            <div class="col-md-3 ml-auto">
                ...
                @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                    <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                        @if($delivery_status == 'confirmed' || $delivery_status == 'pending')
        ...
        <div class="row gutters-5">
            <div class="col text-center text-md-left">
                <address>
                    ...
                    {{ json_decode($order->shipping_address)->address }}, {{ json_decode($order->shipping_address)->thana }}, {{ json_decode($order->shipping_address)->city }} -{{ json_decode($order->shipping_address)->postal_code }}<br>
