...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
    ...
    <!--                    <td>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('all_orders.productlist', $order->id) }}" title="{{ translate('Edit') }}">
                            ...
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('orders.destroy', $order->id)}}" title="{{ translate('Delete') }}">
                             ...
                             <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('all_orders.pickedUp', $order->id) }}" title="{{ translate('Download Invoice') }}">
