            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Order Code')}}<span> {{$order->code}}</span></h5>
                    </div>
                    @php
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <label class="col-md-6 col-from-label">{{$orderDetail->product->name}}</label>
                        </div>
                   
                          <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Discount')}} </label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" value="{{ $orderDetail->product->discount }}" name="discount" class="form-control" >
                            </div>
                            <div class="col-md-3">
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0" value="{{$orderDetail->quantity}}" step="1"  name="current_stock" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
