    	...
    	<div class="card-body">
            <div class="row gutters-5">
                ...
                <div class="col-md-3 ml-auto">
                    ...
                    <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="">
                ...
                <div class="col-md-3 ml-auto">
                    ...
                    @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                        <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                            ...
                            <option value="picked_up" @if ($delivery_status == 'picked_up' || $delivery_status == 'shipped' ) selected @endif>{{translate('Picked Up')}}</option>
    		...
    		<div class="clearfix float-right">
                ...
                <div class="text-right no-print">
                    ...
                    <button class="btn btn-light" id="shipped" value="shipped">{{translate('Shipped')}}</button>
