...
<div class="container aiz-titlebar text-left mt-2 mb-3">
   ...
   {{-- Basic Info --}}
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="{{ route('inhouse_shop.update', Auth::user()->shop->id) }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PATCH">
                @csrf
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('Shop Name') }}<span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Shop Name')}}" name="name" value="{{ $shop->name }}" >
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Thana')}}" name="thana" value="{{ $shop->thana }}" >
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('District') }} <span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('District')}}" name="city" value="{{ $shop->city }}" >
                    </div>
                </div>
