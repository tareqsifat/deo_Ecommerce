...
<section class="mb-4">
    <div class="container text-left">
        <div class="row">
            <div class="col-lg-8">
                <form  class="form-default" role="form" method="POST" id="checkout-form">
                    @csrf
                                ...
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        @if(get_setting('paypal_payment') == 1)
                                            <div class="col-6 col-md-4" id="on_pay">
                                        ...
                                        @endif
                                         @if(get_setting('shurjopay') == 1)
                                            <div class="col-6 col-md-4" id="on_pay">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="shurjopay" class="online_payment" type="radio" name="payment_option" >
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                        ...
                                        @if(get_setting('cash_payment') == 1)
                                            ...
                                            @if($digital != 1 && $cod_on == 1)
                                                <div class="col-6 col-md-4" id="off_pay">
                                                    <label class="aiz-megabox d-block mb-3">
                                                ...
                                                @php
                                                    if($product->advance_payment != 0){
                                                        $partial=$product->advance_payment;
                                                        $amount = ($total*$partial)/100;
                                                        $remaining = $total-$amount;
                                                    }  
                                                @endphp
                                            @endif
                                        @endif
                                        <input value="{{$total}}" name="pamount" type="hidden">
                                        @if (Auth::check())
...
@section('script')
    <script type="text/javascript">
        ...
        $('#on_pay').click(function(){
        $('#checkout-form').attr('action', '{{ route("payment.post") }}');
        });
        
        $('#off_pay').click(function(){
