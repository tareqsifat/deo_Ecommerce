                    ...
                    <div class="col-lg-6">
                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                            ...
                            <div>
                                ...
                                <span class="ml-2">{{ $address->thana }}</span>
                            </div>
                            <div>
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="mb-3">
                                        <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{translate('Select your city')}}" name="district" required>
                                            <option value="">Select City</option>
                                            @foreach (\App\District::get() as $key => $dis)
