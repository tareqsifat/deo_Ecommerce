<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input class="form-control mb-3" value="{{ $address_data->thana }}" name="thana" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <input class="form-control mb-3" value="{{ $address_data->district }}" name="district" required>
            </div>
        </div>
