                    ...
                    @csrf
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="fw-600 ml-2">{{ $address->thana }}</span>
                                                    </div>
                                                    <div>
                        ...
                        @else
                            <div class="shadow-sm bg-white p-4 rounded mb-4">
                                ...
                                <div class="form-group">
                                    <label class="control-label">{{ translate('Thana')}}</label>
                                    <input  class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="thana" placeholder="{{ translate('Thana')}}" required>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">{{ translate('District')}}</label>
                                    <input  class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="district" placeholder="{{ translate('District')}}" required>
                                </div>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input  class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="thana" placeholder="Thana" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-10">
                                  <input  class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="district" placeholder="District" required>
                            </div>
                        </div>
