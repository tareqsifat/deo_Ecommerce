...
<body style="overflow-x: hidden !important;width: 100vw !important;">
    <!-- aiz-main-wrapper -->
    ...
    <!--                   <p><img src="{{static_asset('uploads/all/9FcGpc7IWaJDYHqmFPmzlYOnESrfCbcYnDQXGDbr.png')}}" style="width: 100%;"></p><p style="text-align: center; "><br></p><h2 style="text-align: center; "><b>Subscribe to Our Newsletter</b></h2><p style="text-align: center;">Subscribe our newsletter for coupon, offer and exciting promotional discount..</p>-->
    <!--                </div>-->
