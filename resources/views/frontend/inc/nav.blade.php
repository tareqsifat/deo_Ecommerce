...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="position-relative logo-bar-area z-1 header_section_pc">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white">
                        ...
                        <div class="position-relative flex-grow-1 col-10">
                        ...
                        <div class="typed-search-box stop-propagation document-click-d-none d-none bg-white rounded shadow-lg position-absolute left-0 top-100 w-100" style="min-height: 200px">
                            <div class="search-preloader absolute-top-center">
                                <div class="dot-loader"> <div></div><div></div></div>
                            </div>
    ...
    <div class="position-relative sticky-top header_section_mobile z-1">
            ...
            <div class="col-xs-11">
                <div class="position-relative flex-grow-1">
                    <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                        <div class="d-flex position-relative align-items-center">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light" id="search" name="keyword" @isset($query)
                                    value="{{ $query }}"
                                @endisset placeholder="{{translate('I am shopping for...')}}" style="font-family:Arial, FontAwesome" autocomplete="off">
                                <div class="input-group-append d-none d-lg-block">
                                    <button class="btn btn-primary" type="submit">
                                        <i class="la la-search la-flip-horizontal fs-18"></i>
                                    </button>
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="header_menu_labels bg-white border-top border-gray-200 py-1">
            <div class="container">
...
<script>
    if($(window).width() < 576){
        ...
        $('.header_section_pc').hide();
    }
    else if($(window).width() > 576){
        $('.header_section_mobile').hide();
    }
</script>
