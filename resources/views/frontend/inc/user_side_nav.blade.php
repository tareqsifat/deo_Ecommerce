...
<style>
    ...
    .mobile-nav-icon .orders i {
        color: green;
        font-size: 17px;
    }
    
    .mobile-nav-icon .profile i {
        color: #484883;
        font-size: 15px;
    }
    
    .mobile-nav-icon .address i {
        font-size: 15px;
        color: #e76004;
    }
    
    .mobile-nav-icon .message i {
        color: #e39017;
        font-size: 19px;
    }
    ...
    /*.footer-mobile-nav-icon .mobile-nav-item {*/
    /*    margin-right: 20px;*/
    /*}*/
    
    .footer-mobile-nav-icon i {
        font-size: 15px;
        color: #473a3a;
        margin-bottom: 10px;
    }
...
<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        ...
        <div class="mobile-nav-icon">
           <div class="mobile-nav"> <a href="" class="orders"><i class="far fa-file-spreadsheet"></i></a><span>Orders</span></div>
            <div class="mobile-nav"> <a href="" class="profile"><i class="fas fa-user"></i></a><span>Profile</span></div>
             <div class="mobile-nav"><a href="" class="address"><i class="fas fa-map-marker-alt"></i></a><span>Address</span></div>
             <div class="mobile-nav"><a href="" class="message"><i class="far fa-envelope"></i></a><span>Profile</span></div>
        </div>
        ...
        <div class="footer-mobile-nav-icon">
            <div class="mobile-nav-item"> <a href="" class="home"><i class="fas fa-home"></i></a><span>Home</span></div>
            <div class="mobile-nav-item"> <a href="" class="newsfeed"><i class="fas fa-newspaper"></i></a><span>Newsfeed</span></div>
            <div class="mobile-nav-item"><a href="" class="campaigns"><i class="fal fa-rv"></i></a><span>campaigns</span></div>
            <div class="mobile-nav-item"><a href="" class="cart"><i class="fas fa-shopping-cart"></i></a><span>Cart</span></div>
            <div class="mobile-nav-item"><a href="" class="account"><i class="far fa-user"></i></a><span>Account</span></div>
        </div>
