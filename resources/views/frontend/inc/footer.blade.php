...
<section class="bg-white border-top mt-auto footer_custom">
    <div class="container">
...
<div class="aiz-mobile-bottom-nav fixed-bottom bg-white shadow-lg border-top rounded-top" style="box-shadow: 0px -1px 10px rgb(0 0 0 / 15%)!important; ">
    <div class="row justify-content-center gutters-10">
        ...
        <div class="col-xs-3">
            <a href="{{ route('categories.all') }}" class="text-reset d-block text-center pb-2 pt-3">
                <i class=" fs-20 opacity-60 {{ areActiveRoutes(['categories.all'],'opacity-100 text-primary')}}"></i>
                <span class="material-icons fs-20 opacity-60">apps</span>
                <span class="d-block fs-10 fw-600 mb-2 opacity-60">Categories</span>
            </a>
        </div>
        @php
            if(auth()->user() != null) {
