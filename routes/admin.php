...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/product-advance-payment', 'ProductController@advance_payment')->name('product-advance-payment');
    Route::post('/update-advance-payment', 'ProductController@update_advance_payment')->name('update-advance-payment');
    
    Route::get('/products/control', 'ProductControlController@index')->name('products.control');
    Route::post('/products/update_control', 'ProductControlController@updateControl')->name('products.update_control');
    Route::post('/products/update_category_control', 'ProductControlController@updateCategoryControl')->name('products.update_category_control');
    Route::post('/products/update_brand_control', 'ProductControlController@updateBrandControl')->name('products.update_brand_control');
    ...
    //company_profile
    Route::get('/company_profile', 'BusinessSettingsController@company_profile_index')->name('company_profile.index');
    Route::get('/company_profile/{id}/edit', 'BusinessSettingsController@company_profile_edit')->name('company_profile.edit');
    Route::post('/company_profile/{id}/update', 'BusinessSettingsController@company_profile_update')->name('company_profile.update');
    
    Route::get('/inhouse_shop', 'BusinessSettingsController@inhouse_shop_index')->name('inhouse_shop.index');
    Route::get('/inhouse_shop/create', 'BusinessSettingsController@inhouse_shop_create')->name('inhouse_shop.create');
    Route::post('/inhouse_shop/store', 'BusinessSettingsController@inhouse_shop_store')->name('inhouse_shop.store');
    Route::get('/inhouse_shop/{id}/edit', 'BusinessSettingsController@inhouse_shop_edit')->name('inhouse_shop.edit');
    Route::patch('/inhouse_shop/{id}/update', 'BusinessSettingsController@inhouse_shop_update')->name('inhouse_shop.update');
    ...
    Route::post('/payment_method_zone', 'BusinessSettingsController@payment_method_zone')->name('zone_wise_payment_method');
    ...
    Route::get('/all_orders/{id}/productlist', 'OrderController@all_orders_productlist')->name('all_orders.productlist');
    ...
    Route::get('/all_orders/picked-up/{id}', 'OrderController@all_orders_pickedUp')->name('all_orders.pickedUp');
