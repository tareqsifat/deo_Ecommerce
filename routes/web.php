...
Route::post('/home/section/mobile/featured', 'HomeController@load_featured_section_mobile')->name('mobile.home.section.featured');
Route::post('/home/section/mobile/best_selling', 'HomeController@load_best_selling_section_mobile')->name('mobile.home.section.best_selling');
Route::post('/home/section/mobile/home_categories', 'HomeController@load_home_categories_section_mobile')->name('mobile.home.section.home_categories');
Route::post('/home/section/mobile/best_sellers', 'HomeController@load_best_sellers_section_mobile')->name('mobile.home.section.best_sellers');
...
Route::group(['prefix' => 'checkout', 'middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::post('/partial-payment-select','CheckoutController@partial_payment')->name('partial_payment');
});
...
Route::get('get/thana/{district_id}', 'Admin\HomeController@getThana');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/test-dashboard', 'HomeController@testDashboard')->name('test_dashboard');
    Route::get('/test-addProduct', 'HomeController@testaddProduct')->name('test_addProduct');
...
Route::get('/shurjopay', 'SpaymentController@index')->name('payment.index');
Route::post('/shurjopay', 'SpaymentController@post')->name('payment.post');
