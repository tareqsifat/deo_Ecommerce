...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        if ($request->payment_option != null) {
            ...
            if ($request->session()->get('combined_order_id') != null) {
                if ($request->payment_option == 'paypal') {
                    ...
                    $thana = json_decode($combined_order->shipping_address)->thana;
                    $district = json_decode($combined_order->shipping_address)->district;

                    return PayhereUtility::create_checkout_form($combined_order_id, $amount, $first_name, $last_name, $phone, $email, $address,$thana, $district);
                    ...
                    $shurjopay = new SpaymentController;
                    return $shurjopay->post();
        ...
        $data = [                                                           
                ...
                "msg" => "Test SMS Text {{$user->order->code}} {{$user->name}}"
                ];
                $ch = curl_init();
...
//        if (Session::has('cart') && count(Session::get('cart')) > 0) {
            ...
            foreach ($carts as $key => $cartItem) {
                ...
                if(isset($cartItem['shipping_cost']) && is_array(json_decode($cartItem['shipping_cost'], true))) {
                    ...
                    foreach(json_decode($cartItem['shipping_cost'], true) as $shipping_region => $val) {
                        if($shipping_info['district'] == $shipping_region) {
    ...
    public function order_confirmed()
    {
        ...
        dd($combined_order);
        // dd($combined_order->orders->orderDetails);
        ...
        //     "contacts" => "$phone",
        //     "senderid" => "8809601000500",
        //     "msg" => "Your order has been confirmed. Order Id: $order_id"
        //     ];
        //     $ch = curl_init();
        //     curl_setopt($ch, CURLOPT_URL, $url);
        //     curl_setopt($ch, CURLOPT_POST, 1);
    ...
    //     $response = $client->request('POST', 'https://track.delhivery.com/api/cmu/create.json', [
    //     'json'=>[
    //         'name'=>'sam',
    //         'job'=>'Developer'],
    //     'headers' => [
    //     'Accept' => 'application/json',
    //     'Authorization' => 'Token f0037b247cfe1130ec5b87e1e0602d3256680593',
    ...
    //     echo json_encode($response);
        ...
        //   CURLOPT_POSTFIELDS =>'"raw": "format=json&data=
        // {
        //     "shipments": [{
        //         "add":"M25,NelsonMarg",
        //         "address_type": "home",
        ...
        //         "pin":"411021",
        //         "order": "1",
        //         "client": "EESHANYASURFACE-B2C",
        //         "country": "India",
        //         "cod_amount": 1293.89,
        //         "waybill": ""
        //         }],
        //         "pickup_location": 
        //             {"name":"SF EESHANYA 0101245",
        //             "city": "Pune",
        //             "pin": "411021",
        //             "country":"India",
        //             "phone":"8310418179",
