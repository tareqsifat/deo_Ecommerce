...
//            dd($flash_deal_product);
    ...
    public function advance_payment(Request $request){
        ...
        // dd($products->advance_payment);

        
        return view('backend.product.products.advance_payment', compact('products','col_name','query','sort_search'));
    }
    public function update_advance_payment(Request $request){
        $product = Product::findOrFail($request->product_id);
        
        if ($request->has('advance_payment')) {
            $product->update(["advance_payment" => $request->advance_payment]);
        }
        
        
        return 'advance payment saved successfully';
    }
