...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_method_zone(Request $request){
        
        $zone = AreaZone::where('id', $request->id);
        
        $zone->update(['payment_type'=>$request->payment_type]);
        
        return 'Zone wise payment method updated successfully';
    }
    ...
    public function company_profile_index(){
        $company_pro=CompanyProfile::latest()->get();
        return view('backend.setup_configurations.company_profile.index',compact('company_pro'));
    }
    
     public function company_profile_edit(CompanyProfile $id){
        return view('backend.setup_configurations.company_profile.edit',compact('id'));
    }
    ...
    public function inhouse_shop_index(){
        // $inhouse_shop=Shop::where('user_id',$user->id)->get();
        return view('backend.setup_configurations.inhouse_shop.index');
    }
    public function inhouse_shop_create(){
        return view('backend.setup_configurations.inhouse_shop.create');
    }
    public function inhouse_shop_store(Request $request){
    ...
    public function inhouse_shop_edit($id)
    {
        $shop=Shop::findOrFail($id);
        return view('backend.setup_configurations.inhouse_shop.edit',compact('shop'));
    }
    
    public function inhouse_shop_update(Request $request,$id)
    {
       $shop = Shop::find($id);
       $shop->name             = $request->name;
            $shop->address          = $request->address;
        ...
        if($shop->save()){
            ...
            return redirect()->route('inhouse_shop.index');
        }
