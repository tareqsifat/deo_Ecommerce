...
class HomeController extends Controller
{
    ...
    public function dashboard()
    {
        if(Auth::user()->user_type == 'seller'){
            ...
            // return view('frontend.user.test.index');
        }
    ...
    public function testaddProduct(){
        return view('frontend.user.test.addProduct');
    }
    ...
    public function load_featured_section_mobile(){
        return view('frontend.partials.featured_products_section_mobile');
    }

    public function load_best_selling_section(){
        return view('frontend.partials.best_selling_section');
    }
    public function load_best_selling_section_mobile(){
        return view('frontend.partials.best_selling_section_mobile');
    }
    ...
    public function load_home_categories_section_mobile(){
        return view('frontend.partials.home_categories_section_mobile');
    }

    public function load_best_sellers_section(){
        return view('frontend.partials.best_sellers_section');
    }
    public function load_best_sellers_section_mobile(){
        return view('frontend.partials.best_sellers_section_mobile');
    }
    ...
    public function trackOrder(Request $request)
    {
        if($request->has('order_code')){
            ...
            $curl = curl_init();
curl_setopt($curl, CURLOPT_URL, "https://sandbox.paperflybd.com/API-Order-Tracking");
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS =>'{
"ReferenceNumber" : $request->order_code
}',
